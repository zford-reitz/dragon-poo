...
it('player moves one space up', () => {
    ...
    moveGoblin({G, playerID: '0'}, {row: 1, column: 0});
...
it('player moves one space right', () => {
    ...
    moveGoblin({G, playerID: '0'}, {row: 2, column: 1});
...
it('player fails to move off board by column', () => {
    ...
    const moveOffOfBoard = moveGoblin({G, playerID: '0'}, {row: 2, column: 5});
...
it('player fails to move off board by row', () => {
    ...
    const moveOffOfBoard = moveGoblin({G, playerID: '0'}, {row: 5, column: 2});
...
it('player cannot move into same space as dragon', () => {
    ...
    const moveIntoDragonSpace = moveGoblin({G, playerID: '0'}, {row: 2, column: 1});
...
it('player cannot move through a wall', () => {
    ...
    const moveThroughWall = moveGoblin({G, playerID: '0'}, {row: 2, column: 1});
